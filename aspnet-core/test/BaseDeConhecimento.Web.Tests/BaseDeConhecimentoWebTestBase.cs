...
using BaseDeConhecimento.Models.TokenAuth;
...
{
    public abstract class BaseDeConhecimentoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BaseDeConhecimentoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BaseDeConhecimentoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BaseDeConhecimentoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BaseDeConhecimentoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BaseDeConhecimentoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BaseDeConhecimentoDbContext, Task<T>> func)
        {
            T result;
