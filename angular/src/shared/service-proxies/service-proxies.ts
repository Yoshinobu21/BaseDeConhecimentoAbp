...
export class ArticlesServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ArticleDto> {
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ArticleDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ArticleDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ArticleDtoPagedResultDto>;
        }));
    }
     ...
     * @return Success
     */
    update(body: ArticleDto | undefined): Observable<ArticleDto> {
        let url_ = this.baseUrl + "/api/services/app/Articles/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ArticleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Articles/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
